...
class Album(models.Model):
    band_name = models.ForeignKey(Band, on_delete=models.PROTECT, related_name="album_band")
    album = models.CharField(max_length=300)
    genre = models.ForeignKey(Genre, on_delete=models.PROTECT, related_name="album_genre")
