from albums.forms import AlbumModelForm, BandModelForm, GenreModelForm
from albums.models import Band, Album, Genre
...
class GenresView(ListView):
    ...
    def get_queryset(self):
        genre = super().get_queryset().order_by('genre')
