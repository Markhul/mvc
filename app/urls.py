...
from albums.views import HomeView, AlbumInfoView, BandsView, GenresView, BandInfoView, NewAlbumCreateView, AlbumUpdateView, AlbumDeleteView, NewBandCreateView, NewGenreCreateView
